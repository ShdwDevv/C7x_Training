...
int main(int argc, char **argv)
{
    ...
    fir_1d_se_sa_init(pIn, pCoeff, pOut, INPUT_SIZE, COEFF_SIZE, &pBlock[0]);
    ...
    fir_1d_se_sa(pIn, pCoeff, pOut, INPUT_SIZE, COEFF_SIZE, &pBlock[0]);
    ...
    fir_1d_se_sa_cn(pIn, pCoeff, pOut_cn, INPUT_SIZE, COEFF_SIZE);

#ifndef _HOST_EMULATION  
    t2 = PROFILE_READ;

    printf("Total cycles     : Opt = %5lld, Natc = %5lld\n", (t1 - t0), (t2 - t1));
